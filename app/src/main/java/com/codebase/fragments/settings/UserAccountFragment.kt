...
import com.codebase.aroom.databinding.FragmentUserAccountBinding
import com.codebase.data.User
import com.codebase.util.Resource
import com.codebase.viewmodel.settings.UserAccountViewModel
...
class UserAccountFragment :Fragment() {
   ...
   private val viewModel by viewModels<UserAccountViewModel>()
    ...
    private var aRoomApplication = ARoomApplication()
        ...
        binding.buttonSave.setOnClickListener{
            binding.apply {
                ...
                val user = User(firstName,lastName,email,
                    aRoomApplication.getValueString("user_role").toString()
                )
